...
description: Configure tunnels, ASNs, and routes in the F5 Distributed Cloud Console for routed DDoS mitigation.
sidebar:
  order: 4
---
...
1. Log in to the [F5 Distributed Cloud Console](https://docs.cloud.f5.com/docs-v2/ddos-and-transit-services/how-tos/network-firewall/l3l4-ddos-mitigation) and
